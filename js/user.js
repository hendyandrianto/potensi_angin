$(document).ready(function() { 
	$('#data-user').dataTable({ 
		...
		function( nRow, aData, iDataIndex ) { 
			...
			var action = '<center><a href="javascript:void(0)" onclick="hapus('+"'"+kode+"'"+',\'Data User\',\'user\',\'hapus\')" data-toggle="tooltip" class="btn btn-danger btn-sm" title="Hapus Data"><i class="icon-remove icon-white"></i></a> ' + ' <a href="javascript:void(0)" onclick="edit('+"'"+kode+"'"+',\'Data user\',\'user\',\'edit\')" data-toggle="tooltip" class="btn btn-warning btn-sm" title="Edit Data"><i class="icon-pencil icon-white"></i></a></center>'; 
		...
		"bServerSide": true, 
		"responsive":false, 
		"sAjaxSource": $BASE_URL+"user/get_data" 
	}); 
