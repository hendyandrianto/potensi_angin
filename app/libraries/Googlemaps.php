...
class Googlemaps {
	...
	var $apiKey						= 'API_KEY_GOOGLE_MAPS'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
